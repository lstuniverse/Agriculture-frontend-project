...
export class PortService {
  ...
  getPort() {
    ...
    return this._http.get('../../assets/port.json', {headers: options}).toPromise().then((response: any) => {
  ...
  getPortCompair() {
    ...
    return this._http.get('../../assets/portCompair.json', {headers: options}).toPromise().then((response: any) => {
      const response_object = JSON.parse(response._body);
      return response_object;
    }).catch((error: any) => {
      // ERROR FROM SERVER
  ...
  getEPort() {
    ...
    return this._http.get('../../assets/portE.json', {headers: options}).toPromise().then((response: any) => {
      const response_object = JSON.parse(response._body);
      return response_object;
    }).catch((error: any) => {
      // ERROR FROM SERVER
  ...
  getWPort() {
    ...
    return this._http.get('../../assets/portW.json', {headers: options}).toPromise().then((response: any) => {
      const response_object = JSON.parse(response._body);
      return response_object;
    }).catch((error: any) => {
      // ERROR FROM SERVER
